...
Interpreting our results we see that the best two element models is using Length 1 and Length 3. The best overall model the 5 element model using adjusted R square. 
...
### Best Models
 Interpreting our results we see that the best two element models is using Length 3 and width. The best overall model the 5 element model using length 3 and width using adjusted R square. 
